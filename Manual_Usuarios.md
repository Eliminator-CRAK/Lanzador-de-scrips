...
| El error muestra una ruta dentro de AppData | El EXE no corresponde a la version 1.4.4 o se ha abierto el componente interno. Cierre la app y use el `LanzadorScripts.exe` distribuido. |
