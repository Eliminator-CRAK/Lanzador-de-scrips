<!-- (Autor: Alex Roman) -->
<!-- Descripcion: Uso del cliente LanzadorScripts 1.8.3. -->

# Manual de usuarios

## Elegir version

- Instalada: ejecutar `LanzadorScripts-1.8.3-x64.msi`. Conserva configuracion y runtimes.
- Portable: ejecutar `LanzadorScripts_Portable-1.8.3-x64.exe`. Elimina sus datos locales al cerrar.
...
La version 1.8.3 no necesita `artefactos.key`, `permisos.json`, `catalogo-scripts.json` ni el certificado privado usado por versiones anteriores.
