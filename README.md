...
La unica excepcion Semgrep corresponde a un falso positivo de baja confianza sobre `AnimatePresence` de Framer Motion en el bundle compilado. `Herramientas/ValidarResultadosSemgrep.py` exige que coincidan regla, ruta, linea y SHA-256 del archivo completo. Si el bundle cambia, la excepcion deja de ser valida y el CI obliga a revisarla de nuevo.
