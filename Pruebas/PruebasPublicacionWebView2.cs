...
public sealed class PruebasPublicacionWebView2
{
    ...
    public void ProyectoPublicaVersion170()
    {
        ...
        Assert.Contains("<Version>1.7.2</Version>", proyecto, StringComparison.Ordinal);
        Assert.Contains("<AssemblyVersion>1.7.2.0</AssemblyVersion>", proyecto, StringComparison.Ordinal);
        Assert.Contains("<FileVersion>1.7.2.0</FileVersion>", proyecto, StringComparison.Ordinal);
        ...
        Assert.Contains("v1.7.2", cliente, StringComparison.Ordinal);
