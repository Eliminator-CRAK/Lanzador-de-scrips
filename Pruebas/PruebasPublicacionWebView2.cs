...
public sealed class PruebasPublicacionWebView2
{
    ...
    [Fact]
    public void ProyectoPublicaVersion180()
    {
        ...
        Assert.Contains("<Version>1.8.0</Version>", proyecto, StringComparison.Ordinal);
        Assert.Contains("<AssemblyVersion>1.8.0.0</AssemblyVersion>", proyecto, StringComparison.Ordinal);
        Assert.Contains("<FileVersion>1.8.0.0</FileVersion>", proyecto, StringComparison.Ordinal);
        ...
        Assert.Contains("v1.8.0", cliente, StringComparison.Ordinal);
