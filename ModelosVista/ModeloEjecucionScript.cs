...
public sealed class ModeloEjecucionScript : ObjetoNotificable
{
    ...
    public string RutaLog
    {
        ...
        set
        {
            if (AsignarPropiedad(ref _rutaLog, value))
            {
                NotificarCambioPropiedad(nameof(TextoLog));
            }
        }
    }
    ...
    public int? CodigoSalida
    {
        ...
        set
        {
            if (AsignarPropiedad(ref _codigoSalida, value))
            {
                NotificarCambioPropiedad(nameof(TextoCodigoSalida));
            }
        }
    }
    ...
    public string TextoCodigoSalida => CodigoSalida?.ToString() ?? "-";

    public string TextoLog => string.IsNullOrWhiteSpace(RutaLog)
        ? "Log pendiente"
        : "Log disponible";
